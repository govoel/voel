...
import { Button, Column, LazyColumn, LoadingIndicator } from '@expo/ui/jetpack-compose';
...
import { ChangePassword } from '#src/features/accounts/profile/change-password';
import {
  activeUserProfileAtom,
  useUserProfileForm,
} from '#src/features/accounts/profile/profile-form.ts';
import { OwnSessions } from '#src/features/accounts/profile/sessions';
...
const LoadedProfile = ({
  ...
  return (
    <>
      ...
      <FormSheet open={isEditingProfile} onOpenChange={setIsEditingProfile}>
        {(close) => (
          <Column
